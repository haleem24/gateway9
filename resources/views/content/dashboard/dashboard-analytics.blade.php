        ...
        <div class="card-body text-center">
          ...
          <div class="text-center">
            ...
            <p class="card-text m-auto w-75">
              Your currenct Balance is <strong>{{number_format($current_balance,2)}}</strong>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-header flex-column align-items-start pb-0">
          <div class="avatar bg-light-primary p-50 m-0">
            <div class="avatar-content">
                <i data-feather='corner-left-down' class="font-medium-5"></i>
            </div>
          </div>
          <h2 class="fw-bolder mt-1">{{number_format($mdr_in,2)}}</h2>
          <p class="card-text">MDR IN</p>
        </div>
      </div>
    </div>
    <!-- MDR IN ends -->

    <!-- MDR IN Charges starts -->
    <div class="col-lg-3 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start pb-0">
          ...
          <h2 class="fw-bolder mt-1">{{number_format($in_charges,2)}}</h2>
          <p class="card-text">MDR IN Charges</p>
        </div>
      </div>
    </div>
    <!-- MDR IN Charges ends -->
    ...
    <div class="col-lg-3 col-sm-6 col-12" >
      <div class="card">
        <div class="card-header flex-column align-items-start pb-0">
          ...
          <h2 class="fw-bolder mt-1">{{number_format($mdr_out,2)}}</h2>
          <p class="card-text py-2">MDR Out</p>
        </div>
      </div>
    </div>
    <!-- MDR OUT ends -->

    <!-- MDR OUT Charges starts -->
    <div class="col-lg-3 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start pb-0">
          <div class="avatar bg-light-warning p-50 m-0">
          ...
          <h2 class="fw-bolder mt-1">{{number_format($out_charges,2)}}</h2>
          <p class="card-text py-2">MDR Out Charges</p>
        </div>
      </div>
    </div>
    <!-- MDR OUT Charges ends -->
    ...
    <div class="col-lg-3 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start pb-0">
          ...
          <h2 class="fw-bolder mt-1">{{number_format($settle,2)}}</h2>
          <p class="card-text py-2">Settlements</p>
        </div>
      </div>
    </div>
    <!-- Settlements ends -->

    <!-- Settlement Charges starts -->
    <div class="col-lg-3 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start pb-0">
          <div class="avatar bg-light-warning p-50 m-0">
          ...
          <h2 class="fw-bolder mt-1">{{number_format($settle_charges,2)}}</h2>
          <p class="card-text py-2">Settlement Charges</p>
        </div>
      </div>
    </div>
    <!-- Settlement Charges ends -->
  </div>
  <div class="row match-height">
    ...
    <div class="col-lg-3 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start pb-0">
          ...
          <h2 class="fw-bolder mt-1">{{number_format($rolling_reserve,2)}}</h2>
          <p class="card-text py-2">Other Charges Reserve</p>
        </div>
      </div>
    </div>
    <!-- Other Charges ends -->
    ...
    <div class="col-lg-3 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start pb-0">
          ...
          <h2 class="fw-bolder mt-1">{{number_format($rolling_reserve,2)}}</h2>
          <p class="card-text py-2">Rolling Reserve</p>
        </div>
      </div>
    </div>
    <!-- RR ends -->
